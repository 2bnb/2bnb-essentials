private _editBox = uiNamespace getVariable ["bnb_es_admin_messages_sendBoxCtrl",controlNull];
private _listbox = uiNamespace getVariable ["bnb_es_admin_messages_sendBoxListboxCtrl",controlNull];
...
if ([] call bnb_es_admin_messages_fnc_isAdminOrZeus) then {
