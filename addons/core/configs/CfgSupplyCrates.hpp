...
class CfgVehicles {
	...
	class BNB_ES_Resupply : B_supplyCrate_F {
		author = "Arend";
		vehicleClass="Ammo";
		scope = 0;
	...
	class BNB_ES_Resupply_Class_A : BNB_ES_Resupply {
	...
	class BNB_ES_Resupply_Class_B : BNB_ES_Resupply {
	...
	class BNB_ES_Resupply_Class_C : BNB_ES_Resupply {
