[] spawn {
	...
	if (_climate isEqualTo "woodland" || _climate isEqualTo "all") then {
		...
		["2BNB Flecktarn - Crew",[["BWA3_G38C","","","BWA3_optic_CompM2",["BWA3_30Rnd_556x45_G36",30],[],""],[],["BWA3_P8","","","",["BWA3_15Rnd_9x19_P8",15],[],""],["BWA3_Uniform2_sleeves_Fleck",[["ACE_elasticBandage",5],["ACE_packingBandage",10],["ACE_adenosine",1],["ACE_CableTie",2],["ACE_epinephrine",2],["ACE_IR_Strobe_Item",1],["ACE_morphine",2],["ACE_tourniquet",4],["ACE_MapTools",1],["ACE_Flashlight_XL50",1],["ACE_EarPlugs",1],["BWA3_15Rnd_9x19_P8",1,15]]],["BWA3_Vest_Fleck",[["SmokeShell",3,1],["HandGrenade",2,1],["BWA3_30Rnd_556x45_G36_Tracer_Dim",4,30]]],[],"BWA3_CrewmanKSK_Fleck_Headset","",[],["ItemMap","ItemGPS","TFAR_anprc152","ItemCompass","ACE_Altimeter",""]]] call ace_arsenal_fnc_addDefaultLoadout;
